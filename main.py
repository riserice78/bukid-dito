...
from chart import render_schedule_mobile_friendly, render_summary_table, render_preparation_cards, render_research_cards
...
crew_inputs = {
    ...
    'planting_medium': st.session_state.planting_medium 
}
    ...
    if yes_clicked:
        ...
        with st.chat_message("assistant"):
            with st.spinner(t(
                ...
                #render_preparation_cards(preparation)
